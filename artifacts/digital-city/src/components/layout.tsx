...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <img src="/sanad-logo.svg?v=4" alt="سند" style={{ height: 104, width: "auto" }} draggable={false} />
      ...
      >
        {/* Logo */}
        <img src="/sanad-logo.svg?v=4" alt="سند" style={{ height: 88, width: "auto" }} draggable={false} />
