...
export const deliveryConfigTable = pgTable("delivery_config", {
  ...
  platformCommissionPercent: integer("platform_commission_percent")
    .notNull()
    .default(0),
  prepTimeMinutes: integer("prep_time_minutes").notNull().default(15),
  avgSpeedKmPerMin: real("avg_speed_km_per_min").notNull().default(0.7),
...
export const insertDeliveryConfigSchema = createInsertSchema(
  deliveryConfigTable,
